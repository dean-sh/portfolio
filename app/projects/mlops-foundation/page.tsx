...
"Data Contracts",
 ...
 <h2 className="text-2xl font-bold text-foreground">Why We Needed a New Foundation</h2>
 <p>
 ...
 >
 <h3 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">{item.title}</h3>
...
"Faster onboarding for new contributors",
 ...
 <section className="space-y-5">
 <h2 className="text-2xl font-bold text-foreground">Standardising Packaging with MLflow</h2>
 <p>
...
"Consistent smoke tests + health checks",
 ...
 <section className="space-y-5">
 <h2 className="text-2xl font-bold text-foreground">Introducing the Challenger vs. Champion Loop</h2>
 <p>
...
"Promotion requires the challenger to outperform the champion across multiple weeks.",
 ...
 <section className="space-y-5">
 <h2 className="text-2xl font-bold text-foreground">What This Enabled</h2>
 <div className="grid gap-4 md:grid-cols-2">
 {[
