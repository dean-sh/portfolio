...
export const metadata = {
 ...
 description:
"Forecasting UK's offshore and onshore wind power generation with advanced machine learning models.",
};
...
"Weather Data",
 ...
 <p>
 Wind energy plays a critical role in this transition by offering a
 clean and abundant alternative to fossil fuels, with the UK
 emerging as a leader in wind energy adoption.
 </p>
 </div>
 </section>
 ...
 <div>
 <p className="mb-4">
 The UK has emerged as a leader in wind energy adoption, boasting
 over 14GW of installed capacity and a staggering 23GW planned
 for the future. However, one key hurdle remains: accurately
 ...
 strokeWidth={1.5}
 d="M19.071 4.929a10 10 0 10-14.142 14.142M7.757 7.757a6 6 0 109.9 6.728M12 2v10m0 0l-3-3m3 3l3-3"
 />
 </svg>
 ...
 <div className="prose prose-lg max-w-none">
 <p>
 The very nature of wind makes it notoriously difficult to predict.
 Wind power generation fluctuates constantly due to a complex
 ...
 <p>
 Complex and rapidly changing weather systems affect wind speed
 and direction across the region.
 </p>
 </div>
 ...
 <p>
 Different coastal and inland locations experience distinct wind
 patterns requiring local modeling.
 </p>
 </div>
 ...
 <p>
 Time of day, season, and longer-term climate patterns all
 influence wind generation capability.
 </p>
 </div>
 </div>
 ...
 <div className="mt-6">
 <p>
 This unpredictability poses a significant challenge for grid
 management and ensuring a stable and reliable energy supply,
 making accurate forecasting critical for the energy sector.
 </p>
 </div>
 </section>
 ...
 <p className="mb-6">
 Our project addresses this challenge by developing an advanced
 machine learning model specifically designed for day-ahead wind
 power forecasting. This innovative model goes beyond existing
 solutions, like those used by Elexon, by incorporating a
 bias-correcting linear model.
 </p>

 <div className="bg-muted rounded-lg p-6 shadow-md border border-border mb-6">
 ...
 <span>
 Multi-variable data integration from weather and
 ...
 <span>
 Advanced time series modeling with specialized neural
 networks
 </span>
 </li>
 <li className="flex items-start">
 ...
 <div className="text-5xl font-bold text-foreground mb-2">57%</div>
 ...
 <div className="w-full bg-card/60 rounded-full h-4 relative">
