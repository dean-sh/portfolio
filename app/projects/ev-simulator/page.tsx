...
"Data Visualization",
 ...
 <p className="lead text-xl text-foreground mb-4">
 ...
 className="inline-flex items-center justify-center bg-accent/90 hover:bg-accent text-foreground px-4 py-2 rounded-md transition-colors whitespace-nowrap"
 >
 <svg
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="inline-flex items-center justify-center bg-card hover:bg-card/80 text-foreground px-4 py-2 rounded-md transition-colors whitespace-nowrap"
 >
 <svg
 className="w-5 h-5 mr-2"
 fill="none"
 ...
 <div className="bg-card/70 p-4 rounded-md font-mono text-xs overflow-x-auto">
 <code>
 ...
 <div className="aspect-auto relative rounded-lg overflow-hidden bg-muted p-4 text-center mt-6">
 <div className="bg-card/60 p-5 rounded-lg shadow-inner border border-border">
 ...
 <div className="bg-muted rounded-lg p-4 shadow-md border border-border">
 ...
 <div className="bg-muted rounded-full h-10 w-10 flex items-center justify-center mr-4 shrink-0 mt-1">
